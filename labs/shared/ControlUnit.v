...
module ControlUnit (
    ...
    output reg        Branch,     // 1 = Branch instruction evaluated
    ...
    always @(*) begin
        //     Safe Default Assignments (prevents hardware latches)    
        RegWrite = 1'b0;
        ALUSrcA  = 2'b00;
        ALUSrcB  = 1'b0;
        MemWrite = 1'b0;
        ...
        case (opcode)
            ...
            7'b0110011: begin
                ...
                case (funct3)
                    ...
                    3'b001: ALUop = 3'b101; // SLL (Shift Left Logical)
                    3'b010: ALUop = 3'b110; // SLT (Set Less Than)
                    3'b011: ALUop = 3'b111; // SLTU (Set Less Than Unsigned)
            ...
            7'b1100011: begin
                ...
                ALUop    = 3'b010; // SUB (used to check zero/comparison flags)
            end
            ...
            //                                                              
            7'b1101111: begin
                RegWrite = 1'b1;  // Write return address (PC + 4) to rd
                Jal      = 1'b1;
